...
$form_name_event[$index] = htmlspecialchars($_REQUEST['form-name-event']);
$email_from[$index] = htmlspecialchars($_REQUEST['email-from-update']);
$email_to[$index] = htmlspecialchars($_REQUEST['email-to-update']);
$email_cc[$index] = htmlspecialchars($_REQUEST['email-cc-update']);
$email_bcc[$index] = htmlspecialchars($_REQUEST['email-bcc-update']);
...
$cron_send_email_on[$index] = htmlspecialchars($_REQUEST['cron-send-email-on-update']);
$cron_send_email_on_field[$index] = htmlspecialchars($_REQUEST['cron-send-email-on-field-update']);
$cron_repeat_for[$index] = $_REQUEST['cron-repeat-for-update'];
...
$alert_name[$index] = htmlspecialchars($_REQUEST['alert-name-update']);
