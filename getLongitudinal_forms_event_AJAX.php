...
if(!empty($form) && !empty($project_id)){
    ...
    if(!empty($events_array)){
        ...
        if($queue != "1"){
            ...
            $onchange="getInstances(this);";
        }

        $event_selector .= '<select class="external-modules-input-element" id="'.$selector_id.'" name="'.$selector_name.'" onchange="'.$onchange.'"><option value=""></option>';
