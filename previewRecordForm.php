...
//Email Addresses
$mail = $module->setEmailAddresses($mail, $project_id, $record, $form_name_event, $form_name, 1, $data, $index);
...
$email_text = $module->setDataPipping($datapipe_var, $email_text, $project_id, $data, $record, $form_name_event, $form_name, 1);
$email_subject = $module->setDataPipping($datapipe_var, $email_subject, $project_id, $data, $record, $form_name_event, $form_name, 1);
